      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background via-secondary/10 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-center mb-8 text-primary">
            Плаваем на результат и получаем удовольствие от процесса!
          </h2>
          ...
          <div className="flex justify-center">
            <Button 
              size="lg" 
              className="text-xs md:text-lg px-3 md:px-12 py-4 md:py-6 bg-gradient-to-r from-primary to-accent text-white hover:scale-105 transition-all duration-300 shadow-xl rounded-lg"
              asChild
            >
              <a href="https://api.whatsapp.com/send?phone=79169455813&text=Здравствуйте!%20Хочу%20узнать%20подробнее%20о%20вашей%20методике%20плавания" target="_blank" rel="noopener noreferrer">
                <Icon name="MessageCircle" className="mr-1 md:mr-2 flex-shrink-0" size={16} />
                <span className="whitespace-nowrap">Узнать о нашей методике подробнее!</span>
              </a>
            </Button>
          </div>
        </div>
              ...
              >
                ...
                <CardContent className="p-8">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href="https://api.whatsapp.com/send?phone=79169455813&text=Здравствуйте!%20Хочу%20выбрать%20абонемент" target="_blank" rel="noopener noreferrer">
                      Выбрать абонемент
                    </a>
                  </Button>
                </CardContent>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-white/20 pt-8 text-center">
            <Button
              ...
              asChild
            >
              <a href="https://api.whatsapp.com/send?phone=79169455813&text=Здравствуйте!%20Прошу%20перезвонить%20мне" target="_blank" rel="noopener noreferrer">
